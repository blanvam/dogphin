    ...
    >
      <View style={styles.container}>
        ...
        <ScrollView style={styles.tcContainer} >
          ...
          <Text style={styles.tcP}>La información de posición GPS y las actividades de alerta se mantendrán durante dos (2) años. Sus datos relacionados con la información de su perfil se conservarán hasta que se elimine su cuenta.</Text>
